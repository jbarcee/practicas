...
> Con ```cd /var/www```, creamos la carpeta *web1* con ```mkdir web1 ``` y dentro creamos el archivo *index.html* con ```nano index.html```

![](./img/1.png)

> Accedemos a ``` etc/apache2/sites-available ``` y copiamos el archivo de configuracion default. Cambiamos la información para crear el sitio 1
